...
1. In the **Code** tab of your repository, create a new branch named `welcome-workflow`.
   ...
   <img width="400" alt="create branch screenshot" src="https://github.com/yaswanthbugude/skills-hello-github-actions-Lab-Practice/blob/main/.github/images/create-branch-screenshot.png?raw=true" />
